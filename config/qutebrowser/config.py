...
c.bindings.commands['insert'] = {
    ...
    '<ctrl-alt-l>': 'fake-key <right>',
    '<ctrl-k>': 'fake-key <up>',
    '<ctrl-j>': 'fake-key <down>',
    '<ctrl-u>': 'fake-key <shift-home><delete>',
    '<ctrl-shift-h>': 'fake-key <ctrl-shift-left>',
    '<ctrl-shift-l>': 'fake-key <ctrl-shift-right>',
    '<ctrl-shift-alt-h>': 'fake-key <shift-left>',
    '<ctrl-shift-alt-l>': 'fake-key <shift-right>',
