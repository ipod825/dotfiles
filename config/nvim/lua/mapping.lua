...
map("n", "<m-t>", functional.bind(M.open_term, "Tabdrop"))
map("n", "<m-o>", functional.bind(M.open_term, "split"))
map("n", "<m-e>", functional.bind(M.open_term, "vsplit"))
map("n", "<m-s-t>", function()
	M.reuse_term("Tabdrop", vim.fn.getcwd())
end)
map("n", "<m-s-o>", function()
	M.reuse_term("split", vim.fn.getcwd())
end)
map("n", "<m-s-e>", function()
