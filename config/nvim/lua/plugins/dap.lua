...
return {
	...
	config = function()
		...
		vim.api.nvim_create_user_command("Debug", function()
			...
			vim.cmd("DapToggleBreakpoint")
			local original_mappings = utils.save_keyvim.keymap.set(debug_mappings)
			utils.restore_keyvim.keymap.set(debug_mappings.n, "n")
			utils.restore_keyvim.keymap.set(debug_mappings.v, "v")
			vim.o.mouse = "a"
